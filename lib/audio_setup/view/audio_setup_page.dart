...
///
/// Provides an [AudioSetupCubit] backed by the shared [LooperRepository].
class AudioSetupPage extends StatelessWidget {
  /// Creates an [AudioSetupPage].
  const AudioSetupPage({required this.repository, super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => AudioSetupCubit(repository: repository),
