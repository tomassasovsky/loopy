...
DESCRIPTION = "avrdude programs Atmel AVR microcontrollers. On the loopy \
appliance it is used by `loopy-update-ctl flash-pedal` to write the published \
...
# Carried in meta-loopy because no layer we use provides avrdude (#430):
