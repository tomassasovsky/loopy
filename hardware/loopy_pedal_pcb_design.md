...
>
> **#366 note:** the VAMP console design now puts an LED pill above EVERY pedal
...
| file | what |
|------|------|
| `kicad/loopy_pedal_main.kicad_pcb` (+ `.kicad_pro`) | main board: 82×94 mm, 80 parts, 2-layer, **DRC 0 errors / 0 unrouted** |
