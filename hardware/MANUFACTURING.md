...
| `silent_pedal_plate` | 10 | **1.5 mm CRS steel.** Footswitch top: inverted tray, 4 skirts down 90°, clamshell wraps outside the base; front/rear skirts fold OVER the side-skirt ends — corners close fold-only, no welds, no relief holes (the side folds stop clear of the crossing bend bands). |
