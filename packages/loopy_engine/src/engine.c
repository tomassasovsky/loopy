...
/* Sample-format conversion (le_deinterleave_in / le_interleave_out and their
 * static helpers) and le_asio_pick_buffer moved to engine_convert.c (S1) — pure,
 * engine-state-free, and unit-tested via the engine_internal.h surface. */
