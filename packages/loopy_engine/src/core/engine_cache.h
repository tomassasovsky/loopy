 ...
 * loopy_engine_api.h and defined in engine_cache.c) and NOT the test surface —
 * the private contract between the engine's own TUs.
 */
#ifndef LOOPY_ENGINE_CACHE_H
#define LOOPY_ENGINE_CACHE_H
