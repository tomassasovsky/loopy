/*
 * factory.cpp — "Loopy Delay" plug-in factory + module init/deinit.
 *
...
#define kLoopyDelayVersion "1.0.0"
...
DEF_VST3_CLASS(
    "Loopy Delay", "Fx|Delay", Steinberg::Vst::kDistributable, kLoopyDelayVersion,
    INLINE_UID(LOOPY_DELAY_PROCESSOR_UID_1, LOOPY_DELAY_PROCESSOR_UID_2,
               LOOPY_DELAY_PROCESSOR_UID_3, LOOPY_DELAY_PROCESSOR_UID_4),
    loopy_vst3_delay::Processor::createInstance,
    INLINE_UID(LOOPY_DELAY_CONTROLLER_UID_1, LOOPY_DELAY_CONTROLLER_UID_2,
               LOOPY_DELAY_CONTROLLER_UID_3, LOOPY_DELAY_CONTROLLER_UID_4),
    loopy_vst3_delay::Controller::createInstance)
