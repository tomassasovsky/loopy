/*
 * ids.h — permanent class identity for "Loopy Drive" (umbrella D-GUID).
 *
 ...
 * they ever change, every existing export referencing "Loopy Drive" silently
...
// clang-format off
#define LOOPY_DRIVE_PROCESSOR_UID_1 0x4B97C4B2
#define LOOPY_DRIVE_PROCESSOR_UID_2 0xDF150FA1
#define LOOPY_DRIVE_PROCESSOR_UID_3 0xADF39F6E
#define LOOPY_DRIVE_PROCESSOR_UID_4 0x82E97A25

#define LOOPY_DRIVE_CONTROLLER_UID_1 0xF52D0954
#define LOOPY_DRIVE_CONTROLLER_UID_2 0x50C594A7
#define LOOPY_DRIVE_CONTROLLER_UID_3 0x4D486598
#define LOOPY_DRIVE_CONTROLLER_UID_4 0x3BA47EF2

DECLARE_UID(kProcessorUID, LOOPY_DRIVE_PROCESSOR_UID_1, LOOPY_DRIVE_PROCESSOR_UID_2,
            LOOPY_DRIVE_PROCESSOR_UID_3, LOOPY_DRIVE_PROCESSOR_UID_4)
DECLARE_UID(kControllerUID, LOOPY_DRIVE_CONTROLLER_UID_1, LOOPY_DRIVE_CONTROLLER_UID_2,
