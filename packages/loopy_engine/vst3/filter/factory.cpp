/*
 * factory.cpp — "Loopy Filter" plug-in factory + module init/deinit.
 *
...
#define kLoopyFilterVersion "1.0.0"
...
DEF_VST3_CLASS(
    "Loopy Filter", "Fx|Filter", Steinberg::Vst::kDistributable, kLoopyFilterVersion,
    INLINE_UID(LOOPY_FILTER_PROCESSOR_UID_1, LOOPY_FILTER_PROCESSOR_UID_2,
               LOOPY_FILTER_PROCESSOR_UID_3, LOOPY_FILTER_PROCESSOR_UID_4),
    loopy_vst3_filter::Processor::createInstance,
    INLINE_UID(LOOPY_FILTER_CONTROLLER_UID_1, LOOPY_FILTER_CONTROLLER_UID_2,
               LOOPY_FILTER_CONTROLLER_UID_3, LOOPY_FILTER_CONTROLLER_UID_4),
    loopy_vst3_filter::Controller::createInstance)
